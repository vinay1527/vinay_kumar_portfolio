        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-6 text-left">
            ...
            <div className="text-center">
              <button type="submit" className="px-10 py-3 bg-cyan-500 text-black font-semibold rounded-md transition-all duration-300 hover:bg-cyan-400 hover:neon-glow-blue">
                Send Message
              </button>
            </div>
          </form>
